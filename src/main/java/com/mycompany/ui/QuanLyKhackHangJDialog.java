 ...
 * @author Just Share
 */
public class QuanLyKhackHangJDialog extends javax.swing.JDialog {

    /**
     * Creates new form QuanLyKhackHangJDialog
     */
    public QuanLyKhackHangJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyKhackHangJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QuanLyKhackHangJDialog dialog = new QuanLyKhackHangJDialog(new javax.swing.JFrame(), true);
